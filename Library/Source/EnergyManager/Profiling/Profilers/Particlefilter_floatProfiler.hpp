...
class Particlefilter_floatProfiler : public EnergyManager::Profiling::Profilers::Profiler {
...
public:
	/**
	 * Creates a new Particlefilter_floatProfiler.
	 * @param arguments The command line arguments that were passed when starting.
	 */
	explicit Particlefilter_floatProfiler(const std::map<std::string, std::string>& arguments);
};