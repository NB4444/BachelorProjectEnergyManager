...
class BandwidthProfiler : public EnergyManager::Profiling::Profilers::Profiler {
...
public:
	/**
	 * Creates a new BandwidthProfiler.
	 * @param arguments The command line arguments that were passed when starting.
	 */
	explicit BandwidthProfiler(const std::map<std::string, std::string>& arguments);
};