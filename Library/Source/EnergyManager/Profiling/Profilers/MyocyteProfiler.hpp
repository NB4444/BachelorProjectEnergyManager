...
class MyocyteProfiler : public EnergyManager::Profiling::Profilers::Profiler {
...
public:
	/**
	 * Creates a new MyocyteProfiler.
	 * @param arguments The command line arguments that were passed when starting.
	 */
	explicit MyocyteProfiler(const std::map<std::string, std::string>& arguments);
};