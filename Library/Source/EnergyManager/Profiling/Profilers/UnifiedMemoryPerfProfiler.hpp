...
class UnifiedMemoryPerfProfiler : public EnergyManager::Profiling::Profilers::Profiler {
...
public:
	/**
	 * Creates a new UnifiedMemoryPerfProfiler.
	 * @param arguments The command line arguments that were passed when starting.
	 */
	explicit UnifiedMemoryPerfProfiler(const std::map<std::string, std::string>& arguments);
};